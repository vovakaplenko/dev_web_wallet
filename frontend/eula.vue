                ...
                <div class="ibox">
                    <div class="ibox-body">
                        <div class="d-flex justify-content-between m-b-20">
                            <div>
                                <h3 class="m-0">EULA (End User Software License Agreement)</h3>
                            </div>

                        </div>
                        <div class="ibox-fullwidth-block">
                            <div class="form-group" style="padding:5%">
                                <p >PLEASE READ THIS CONTRACT CAREFULLY. BY USING ALL OR ANY PORTION OF THE POS WEB AND MOBILE DEVCORE WALLET SOFTWARE YOU ACCEPT ALL THE
                                ...
                                <p ><br><b>1.	Definitions</b></p>
                                <p >When used in this Agreement, the following terms
                                ...
                                <p ><b>"Licensor"</b> means Devcore, with its main address
                                    located at Suite 3 Level 27, Governor Macquarie Tower, 1 Farrer Place, Sydney, NSW, 2000.</p>
                                <p ><b>"Software"</b> means (a) all of the contents of the files,
                                    disk(s), CD-ROM(s) or other media with which this Agreement is provided, including but not
                                    limited to (i) Devcore or third party computer information or software; (ii) digital images,
                                    ...
                                    Devcore (collectively, "Updates"). </p>
                                <p ><b>"Use"</b> or <b>"Using"</b> means to access, install, download,
                                    copy or otherwise benefit from using the functionality of the Software in accordance with the
                                    Documentation. </p>
                                <p ><b>"Licensee"</b> means You or Your Company, unless otherwise indicated.</p>
                                <p ><b>"Permitted Number"</b> means one (1) unless otherwise indicated under
                                    a valid license (e.g. volume license) granted by Devcore.</p>
                                <p ><b>"Computer"</b> means an electronic device that accepts information in
                                    digital or similar form and manipulates it for a specific result based on a sequence of instructions.</p>
                                <p ><br><b>2.	Software License</b></p>
                                <p >As long as you comply with the terms of this End User License Agreement (the
                                    "Agreement"), Devcore grants to you a non-exclusive license to Use the Software for the purposes described
                                ...
                                <p ><br><b>2.1	General Use</b></p>
                                <p >You may install and Use a copy of the Software on your compatible computer,
                                    up to the Permitted Number of computers; or</p>
                                <p ><br><b>2.2	Server Use</b></p>
                                <p >You may install one copy of the Software on your computer file server for the
                                    ...
                                    to use this copy of the Software through a valid license from Devcore; and</p>
                                <p ><br><b>2.3	Backup Copy</b></p>
                                <p >You may make one backup copy of the Software, provided your backup copy is not installed
                                ...
                                <p ><br><b>2.4	Home Use </b></p>
                                <p >You, as the primary user of the computer on which the Software is installed, may also install
                                ...
                                <p ><br><b>2.5	Stock Files</b></p>
                                <p >Unless stated otherwise in the "Read-Me" files associated with the Stock Files, which may
                                ...
                                <p ><br><b>2.6	Limitations</b></p>
                                <p >To the extent that the Software includes Devcore Devgate software, (i) you may customize the
                                    installer for such software in accordance with the restrictions found at <a href="https://devcore.io">https://devcore.io</a>
                                    ...
                                    or create a new installer for any of such software, (ii) such software is licensed and distributed by Devcore, and (iii) you are
                                    ...
                                    however, such use is authorized with Devcore, Devcore Devgate, and other current and future Devcore products. For information on
                                    how to distribute Devgate please refer to the sections entitled "How to Distribute Devgate" at
                                    <a href="https://devcore.io">https://devcore.io</a>.</p>
                                <p ><br><b>3.	Intellectual Property Rights</b></p>
                                <p >The Software and any copies that you are authorized by Devcore to make are the intellectual property
                                    of and are owned by Devcore and its suppliers. The structure, organization and code of the Software are the valuable trade secrets
                                    and confidential information of Devcore and its suppliers. The Software is protected by copyright, including without limitation by
                                ...
                                <p >Any copies that you are permitted to make pursuant to this Agreement must contain the same copyright
                                    ...
                                    first requested Devcore to provide the information necessary to achieve such operability and Devcore has not made such information
                                    available.</p>
                                <p >Devcore has the right to impose reasonable conditions and to request a reasonable fee before providing
                                    such information. Any information supplied by Devcore or obtained by you, as permitted hereunder, may only be used by you for the
                                    ...
                                    to the expression of the Software. Requests for information should be directed to the Devcore Customer Support Department. Trademarks
                                ...
                                <p ><br><b>4.	Transfer</b></p>
                                <p >You may not, rent, lease, sublicense or authorize all or any portion of the Software to be copied onto
                                    ...
                                    of the Software.</p>
                                <p ><br><b>5.	Multiple Environment Software / Multiple Language Software / Dual Media Software / Multiple
                                    Copies/ Bundles / Updates</b></p>
                                <p >If the Software supports multiple platforms or languages, if you receive the Software on multiple media, if
                                    ...
                                    the Update are also transferred to such party or computer; and you acknowledge that any obligation Devcore may have to support the previous version
                                    of the Software may be ended upon availability of the Update.</p>
                                <p ><br><b>6.	NO WARRANTY</b></p>
                                <p >The Software is being delivered to you "AS IS" and Devcore makes no warranty as to its use or performance. Devcore AND
                                    ...
                                    REPRESENTATION OR TERM TO THE EXTENT TO WHICH THE SAME CANNOT OR MAY NOT BE EXCLUDED OR LIMITED BY LAW APPLICABLE TO YOU IN YOUR JURISDICTION, Devcore
                                ...
                                <p ><br><b>7.	Pre-release Product Additional Terms</b></p>
                                <p >If the product you have received with this license is pre-commercial release or beta Software ("Pre-release Software"), then
                                    ...
                                    You acknowledge that the Software is a pre-release version, does not represent final product from Devcore, and may contain bugs, errors and other problems that
                                    could cause system or other failures and data loss. Consequently, the Pre-release Software is provided to you "AS-IS", and Devcore disclaims any warranty or
                                    liability obligations to you of any kind. WHERE LEGALLY LIABILITY CANNOT BE EXCLUDED FOR PRE-RELEASE SOFTWARE, BUT IT MAY BE LIMITED, DEVCORE'S LIABILITY AND
                                    THAT OF ITS SUPPLIERS SHALL BE LIMITED TO THE SUM OF FIFTY DOLLARS (U.S. $50) IN TOTAL. You acknowledge that Devcore has not promised or guaranteed to you that
                                    Pre-release Software will be announced or made available to anyone in the future, that Devcore has no express or implied obligation to you to announce or
                                    introduce the Pre-release Software and that Devcore may not introduce a product similar to or compatible with the Pre-release Software. Accordingly, you
                                    ...
                                    done entirely at your own risk. During the term of this Agreement, if requested by Devcore, you will provide feedback to Devcore regarding testing and use of
                                    ...
                                    the Devcore Serial Agreement for Unreleased Products, your use of the Software is also governed by such agreement. You agree that you may not and certify that
                                    ...
                                    release by Devcore of a publicly released commercial version of the Software, whether as a stand-alone product or as part of a larger product, you agree to
                                    return or destroy all earlier Pre-release Software received from Devcore and to abide by the terms of the End User License Agreement for any such later versions
                                    ...
                                    when such date is earlier than the date for Devcore's first commercial shipment of the publicly released (commercial) Software.</p>
                                <p ><br><b>8.	LIMITATION OF LIABILITY</b></p>
                                <p >IN NO EVENT WILL DEVCORE OR ITS SUPPLIERS BE LIABLE TO YOU FOR ANY DAMAGES, CLAIMS OR COSTS WHATSOEVER OR ANY CONSEQUENTIAL, INDIRECT,
                                    INCIDENTAL DAMAGES, OR ANY LOST PROFITS OR LOST SAVINGS, EVEN IF AN DEVCORE REPRESENTATIVE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH LOSS, DAMAGES, CLAIMS OR
                                    COSTS OR FOR ANY CLAIM BY ANY THIRD PARTY. THE FOREGOING LIMITATIONS AND EXCLUSIONS APPLY TO THE EXTENT PERMITTED BY APPLICABLE LAW IN YOUR JURISDICTION. DEVCORE'S
                                    ...
                                    contained in this Agreement limits Devcore's liability to you in the event of death or personal injury resulting from Devcore's negligence or for the tort of
                                    deceit (fraud). Devcore is acting on behalf of its suppliers for the purpose of disclaiming, excluding and/or limiting obligations, warranties and liability as
                                    ...
                                    end of this Agreement, if any, or contact Devcore's Customer Support Department.</p>
                                <p ><br><b>9.	Export Rules (OPTIONAL - FOR AMERICAN COMPANIES)</b></p>
                                <p >You agree that the Software will not be shipped, transferred or exported into any country or used in any manner prohibited by the
                                    ...
                                    Agreement.</p>
                                <p ><br><b>10.	Governing Law</b></p>
                                <p >This Agreement shall be governed by and interpreted in accordance with the laws of the Melbourne, Victoria, Australia.</p>
                                <p ><br><b>11.	General Provisions</b></p>
                                <p >If any part of this Agreement is found void and unenforceable, it will not affect the validity of the balance of the Agreement,
                                    ...
                                    This Agreement may only be modified by a writing signed by an authorized officer of Devcore. Updates may be licensed to you by Devcore with additional or
                                    different terms. This is the entire agreement between Devcore and you relating to the Software and it supersedes any prior representations, discussions,
                                    undertakings, communications or advertising relating to the Software.</p>
                                <p ><br><b>12.	Notice to U.S. Government End Users</b></p>
                                <p >The Software and Documentation are "Commercial Items," as that term is defined at 48 C.F.R. §2.101, consisting of "Commercial Computer Software" and "Commercial Computer Software Documentation," as such terms are used in 48 C.F.R.
                                    ...
                                    laws of the United States. For U.S. Government End Users, Devcore agrees to comply with all applicable equal opportunity laws including, if appropriate, the
                                ...
                                <p ><br><b>13.	Compliance with Licenses</b></p>
                                <p >If you are a business or organization, you agree that upon request from Devcore or Devcore 's authorized representative, you will
                                    within thirty (30) days fully document and certify that use of any and all Devcore Software at the time of the request is in conformity with your valid licenses
                                    from Devcore.</p>
                                <p >If you have any questions regarding this Agreement or if you wish to request any information from Devcore please use the address
                                    and contact information included with this product to contact the Devcore office serving your jurisdiction.</p>
                                <p >Devcore, Devgate, and all other Devcore's products are either registered trademarks or trademarks of Devcore in the United States,
